      ...
      <div className="lg:pl-64 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 bg-white/90 px-6 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/credits"
              className="flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50/70 px-3 py-1.5 text-xs font-semibold text-indigo-700 hover:bg-indigo-100 transition shadow-xs"
            >
