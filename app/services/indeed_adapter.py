...
class IndeedAdapter(BrowserSiteAdapter):
    """Indeed application adapter."""
    ...
    def open_application(
        ...
        try:
            ...
            return ApplicationExecutionResult(
                status="opened",
                url=url,
                message="Indeed application page opened.",
            )
            ...
            return ApplicationExecutionResult(
                ...
                url=url,
                message=(
                    f"Failed to open Indeed page: {error}"
                ),
            )
